...
1) De tre citerade Event-55-posterna kontrollerade individuellt (get_record): rec1SD7i2467gPrJ9 (Deltagare 48) — Person=rectj3ixgMylQYAGH, Deltaganden=[recOegRhShzHSAhVA, recdmtBXPLI31KFst]. rec3A0IJir34yoekd (Deltagare 58) — Person=recAZF4Y7Y0AyKFNq, Deltaganden=[rec7DqQxio6JHQz9f, recVeIvI9tXjQGZEj] (dessutom omlänkad till Event-64 2026-08-21 av annan orsak, S110, ej relaterat). recViNdItldmL6O8l (Deltagare 88) — Person=recT8y8DvaZz09gtW, Deltaganden=[recMWeqVjQQJOXw83, recWHBijU0uuV1l4w]. Samtliga TRE redan Person-länkade med Deltaganden-rader — fälla 16/21-läkningen har redan skett för dessa (troligen manuell Person-PATCH av Marcus/Code i en tidigare session, exakt så som kortet beskriver att kedjan läker).
