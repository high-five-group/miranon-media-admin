...
SKARPBEVIS BETALT 2026-08-08 (S99 resume 3): Marcus körde '/compact test av grinden' i skarp session utan markörfil — hooken FÄLLDE med anvisningstexten synlig i terminalen, verbatim: 'Compaction blocked by PreCompact hook: [bash "CLAUDE_PROJECT_DIR/scripts/deny-precompact.sh"]: COMPACT-FORMEN (ADR-101, TASK-160.2): ingen markörfil (.../worktrees/s99-resume-3/.claude/precompact-markor.json) — läget är inte säkrat i fil. Kör pre-compact-skillen FÖRST...'. Beviset täcker differentialreceptets steg 1: (1) hooken är LADDAD och fyrar på PreCompact-eventet i skarp session, (2) trigger=manual utan markör NEKAS, (3) stderr når användaren, (4) markör-pathen resolvas korrekt till sessionens WORKTREE via CLAUDE_PROJECT_DIR (parallell-läge). Kvar obevisat skarpt: steg 3 (släpp med färsk markör — betalas vid första naturliga kompaktering, medvetet val att inte bränna sessionens enda) + steg 4 (auto-grenens naturliga fyrning vid 160.5-tröskeln).
<!-- SECTION:NOTES:END -->
