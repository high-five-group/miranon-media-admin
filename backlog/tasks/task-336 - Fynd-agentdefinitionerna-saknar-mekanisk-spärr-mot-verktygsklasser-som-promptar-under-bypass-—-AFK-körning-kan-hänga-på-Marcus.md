...
## AC #3 — två mätningar, öppen (S112 resume 2, 2026-08-28)

Haiku-agent #1 (före huvudkatalogens ff): gamla definitionen. Haiku-agent #2 (EFTER ff till cd98862a): FORTFARANDE gamla — ingen AFK-rubrik, ToolSearch returnerar mcp__vercel__* och mcp__claude_ai_Airtable__ping (båda på deny-listan). Slutsats: agentdefinitioner läses vid SESSIONSSTART, inte vid ff (samma klass som CLAUDE.md § Skarpbevis-skulden för review-agent.md). AC #3 betalas som nästa sessions första handling: spawna bygg-agent, verifiera AFK-rubrik + att ToolSearch '+mcp vercel' ger noll.
<!-- SECTION:NOTES:END -->
