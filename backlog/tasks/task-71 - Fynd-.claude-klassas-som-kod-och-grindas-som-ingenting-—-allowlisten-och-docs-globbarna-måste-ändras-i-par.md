...
VERIFIERAT: arbetet är landat på `main`; 11 commits refererar kortet, senast `a702c61`. Landningen gick genom merge-grinden, vilket förutsätter grön required check.
