...
- [x] #4 Korshänvisning: lessons-fragmentets 'kvarstår som prosa'-rad uppdaterad att peka på den nya bäraren; docs-grindarna gröna; PR armerad, per-jobb-grön
<!-- AC:END -->
...
[TASK-169, backlog-städet, 2026-08-09] AC#4+DoD#1+#3 bockade mot belägg. AC#4: tasks/lessons.d/parkerad-pr-utan-draft-ar-oskiljbar-fran-glomd.md innehåller stycket 'Bar av mekanism sedan TASK-153 (2026-08-07): åtgärdsregeln ... är kodifierad i CLAUDE.md § Landning ... i stället för i det här fragmentet'; CLAUDE.md rad ~450 bär motsvarande text — verifierat på disk. DoD#3: PR #877 (merge 8f007d21, 2026-08-07T11:54:58Z) — samtliga CI-jobb SUCCESS/SKIPPED korrekt (docs-only-diff).
<!-- SECTION:NOTES:END -->
