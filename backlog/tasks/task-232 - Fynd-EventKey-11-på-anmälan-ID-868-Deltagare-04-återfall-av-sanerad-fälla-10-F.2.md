...
id: TASK-232
title: >-
  Fynd: EventKey 11 på anmälan ID 868 (Deltagare 04) - återfall av sanerad fälla
  10/F.2
status: Done
assignee: []
...
Kortet beskriver EN rad (ID 868, Deltagare 04). Mätning mot prod-basen (app8uGPrVCVOm6LfD, tbloOcrppVoyrHbrq, REST paginerad, 2026-08-17) visar 26 rader med EventKey utan Event-prefix — inom den delmängd (294 rader) som saknade Inskickad. Hela tabellen är INTE genomsökt för detta; 26 är ett GOLV, inte totalen.
