...
Stangningsbatch 2 (S112 resume 1, 2026-08-26): vantar Marcus: bash scripts/deploy-prod-functions.sh --audit --project-ref <prod-ref> - refen anges av Marcus (scripts/deny-prod-ref.sh faller varje agent-anrop med prod-refen, TASK-203-laset). AC #2 + shellcheck-strict bockade av byggagenten; AC #1 kravs skarpt av Marcus.
<!-- SECTION:NOTES:END -->
