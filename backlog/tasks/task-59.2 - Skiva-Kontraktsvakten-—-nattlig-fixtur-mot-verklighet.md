...
VERIFIERAT: arbetet är landat på `main`; 7 commits refererar kortet, senast `abd91f1`. Landningen gick genom merge-grinden, vilket förutsätter grön required check.
