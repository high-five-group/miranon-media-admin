...
- [x] #9 Inga befintliga E2E-filer raderas i denna skiva; ett test vars subjekt flyttar hör till skivan som äger subjektet, inte till denna
- [x] #10 Markera-lägets kandidatmängd är den RENDERADE listan, inte den gamla obekräftade-kön — samma form facit redan bär (registerListaA), så att senare filtrering följer med automatiskt
- [x] #11 Markera-knappen har en egen förankring utanför de rivna sektionsrubrikerna; ingen del av markera-lägets ÖVRIGA form (batch-barens knapptext, bekräfta-flödets rivning, interim-utgången) rörs här — den ägs av TASK-145.3
<!-- AC:END -->
