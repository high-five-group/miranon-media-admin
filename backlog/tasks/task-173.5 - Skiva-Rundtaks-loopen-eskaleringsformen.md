...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Runda 2 körs i färsk kontext och blockerar endast på error-klass; warnings/info bokförs i utlåtandet utan att stoppa
- [ ] #2 Efter runda 2 sker aldrig en tredje automatisk runda — kvarvarande öppna fynd presenteras som markeringsbar STOPPA-OCH-FRÅGA-lista i chatten och armeringen väntar på Marcus beslut
- [ ] #3 auto-fix-klassade fynd routas till bygg-agenten för rättning; ask-user-klassade eskaleras till Marcus oavsett runda
- [ ] #4 Grinden självgodkänner aldrig vid tak — taket byter automatik mot eskalering
<!-- AC:END -->
