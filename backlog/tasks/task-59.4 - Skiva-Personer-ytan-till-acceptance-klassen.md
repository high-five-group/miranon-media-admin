...
VERIFIERAT: arbetet är landat på `main`; 5 commits refererar kortet, senast `c964fc0`. Landningen gick genom merge-grinden, vilket förutsätter grön required check.
