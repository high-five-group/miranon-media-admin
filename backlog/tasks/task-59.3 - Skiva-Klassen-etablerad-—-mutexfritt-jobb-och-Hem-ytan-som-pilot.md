...
VERIFIERAT: arbetet är landat på `main`; 8 commits refererar kortet, senast `d7e74d3`. Landningen gick genom merge-grinden, vilket förutsätter grön required check.
