...
VERIFIERAT: arbetet är landat på `main`; 10 commits refererar kortet, senast `7ca0926`. Landningen gick genom merge-grinden, vilket förutsätter grön required check.
