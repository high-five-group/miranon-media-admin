...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 get-activity-log returnerar totalantalet för den filtrerade frågan som ADDITIVT svarsfält — befintliga konsumenter obrutna
- [x] #2 Statusraden visar 'Visar N av TOTAL poster.' när fler finns och 'Visar alla N poster.' när allt är laddat
- [x] #3 Acceptance-sviten täcker den nya statusrads-copyn
<!-- AC:END -->
