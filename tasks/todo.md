...
- [ ] **Fas 2.5 — Schema-kontrakt-sync** (carry → Session 13; **huvudtema efter ADR-043-bygget**) — per `docs/byggplan.md` §4.5. Förutsätter att lifecycle-skill-paret är aktivt så fas-arbetet får rätt mekanik från start.
