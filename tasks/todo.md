...
- [ ] **Fas 2.5 — Schema-kontrakt-sync** (Session 13 huvudtema; **ÖPPEN för schema-sync-arbete**) — per `docs/byggplan.md` §4.5. **Synk-gate 1 STÄNGD 2026-06-10** (Marcus-kvittens): A1–A8 EJ APPLICERADE → kategori "Efter Fas 2.5", A9–A11 preserve, A12 defer; schema-frys gäller tills fasen stängs. Inventering: [`docs/research/datamodell-research/09-a1-a12-synk-gate-1-inventering.md`](../docs/research/datamodell-research/09-a1-a12-synk-gate-1-inventering.md). Gate-drift i byggplan korrigerad mot A4 (`121785b`). Trail: [`tasks/sessions/2026-06-10-session-13.md`](sessions/2026-06-10-session-13.md) Del 2.
