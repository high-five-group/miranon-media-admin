...
- [ ] **ADR-043-bygge — inkrement 3–5** (carry) — per [ADR-043](../docs/decisions/ADR-043-session-lifecycle-skills-arkitektur.md) Implementationsplan: Chat-halvor (session-start/end/resume SKILL.md, claude.ai-upload, `/`-anrop + T1′-swap pekare→bas) + handoff-kontrakt + discovery-/dogfood-test.
