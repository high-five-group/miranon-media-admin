...
*Kadens (TASK-464.7, ADR-133 § Besluten 5): varje session äger och synkar ENDAST sitt eget stycke — aldrig denna rad och aldrig en annan sessions stycke. Nyaste läge: se **Session N**-stycket direkt nedan (nyast överst) och § Aktuellt fokus; äldre sessioner har egna `### Session N`-rubriker längre ned i filen (78–84 migrerade hit från den gamla kedjan). Denna rad är STATISK — den ska ALDRIG skrivas om vid en landning; den ersätter den tidigare EN-rad-per-landning-kedjan som kolliderade mellan parallella sessioner (S126/S127/S128, 2026-09-19).*
