...
|---|---|---|---|---|---|---|---|
| 17.7 (diff adb2c614 → ompass. e1e29f45) | 7 (2/5) | 6 | 1 (fynd 5: text-[10px]-badgen — facit-låst form, öppet bokförd mot spec-regeln i kod + kort; 6a-delen likaså bokförd degradering) | 0 | 1 blocker (print-huvud i kalenderläget) / 6 kvalitet | ~10 (två pass) | **1 design-escape** (RÄTTAD från 0 samma dag: filterpanelens grå rand i stängt läge — until-found-klassen L341 — fångades av Marcus EFTER Done-flippen; fixad i fix-våg 1 PR #188. Ursprungskvittensen "OK" föll före randen upptäcktes) |
