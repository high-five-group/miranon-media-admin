...
>
> _T21-not: Uppstod Session 27 (T16 Pass 2 Commit B — EF-sektion → T19-pekare i data-model.md). TVÅ cross-repo-rester, båda psionautics-repo-frågor (utanför detta repos scope, eget Claude-chatt-projekt). (1) SYNK-DRIFT: data-model.md är primär i miranon-media-admin men synkas manuellt till `~/Repon/psionautics/docs/data-model.md` (synk-blurben: "redigera ALLTID denna fil först", synk separat = Marcus manuella moment). Commit B tömde EF-sektionen HÄR (−200 rader psionautics-EF-innehåll → T19-pekare); psionautics-kopian bär fortfarande hela den stale EF-sektionen (~203 rader, dess rad ~808–1011). Kopiorna driftar tills psionautics-synk körs. (2) PEKAR-DÖD-ÄNDE: T19-pekaren säger "se tråd T19 (`tasks/threads/README.md`)" — en miranon-media-admin-fil. En psionautics-läsare som synkar in pekaren hittar ingen T19 i sitt repo. VAD TRÅDEN BÖR GÖRA: när psionautics-synken körs (Marcus-moment) ska psionautics-kopians EF-sektion INTE bara spegla admin-pekaren rakt av — den behöver en repo-agnostisk formulering (peka på interaktions-doket direkt när det finns, eller en referens som funkar från båda repon). Detta är i praktiken ett DELPROBLEM AV T19: när T19-interaktions-doket byggs (efter 6c) måste det avgöras hur kontraktet refereras från BÅDA kopiorna. FÖRSTA FRÅGAN: ska data-model.md ens ha psionautics-synk för interaktions-DELEN, eller divergerar repona medvetet där (admin har EF:er, psionautics har sina egna)? Om medveten divergens → synk-blurben behöver nyansera "synka allt" till "synka schema/datakvalitet, EF-delen är repo-specifik". Blockerar ej; defer. Knyts till T19 + Marcus psionautics-synk-moment. Rad räcker nu._
