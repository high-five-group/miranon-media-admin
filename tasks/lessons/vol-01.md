...
# tasks/lessons/vol-01.md — Universella lärdomar, volym 1

> **STÄNGD volym** · tematisk pre-numrerings-era (2026-03-19 → 2026-05-04): lärdomar innan L-numreringen infördes — tematiska sektioner (Kritiska regler · Stack-specifika lärdomar · Design och UI · Arbetsflöde och process · Klient-specifikt · Mönster som fungerar · Audit och kvalitetsprocess) samt Arkiv: Vue-projektets lärdomar (referens, 2026-03-19 → 2026-04-07).
>
