...
**Väntar på Marcus omstämpling** (`ADR-104` beslut 1–2). Inget stämpel-fält är
rört av denna commit — ytan har inget manifest att röra, och `S111`-manifestets
`godkand` står kvar med sin 2026-08-23-kvittens och sha `cb7ad681`.
