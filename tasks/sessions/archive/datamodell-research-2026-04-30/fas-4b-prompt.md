...
>
> **Plats:** `~/Repon/miranon-media-admin/tasks/sessions/archive/datamodell-research-2026-04-30/fas-4b-prompt.md`
...
- **Fas 2 (KLAR — Gate 2 passerad):** `docs/research/datamodell-research/04-research.md` Del 1 — 10 principer P1–P10 + R7 stickprov.
- **Fas 3 (KLAR — Gate 3 passerad):** `docs/research/datamodell-research/05-gap-vs-worldclass.md` — 15 gap (G1–G15) + DS/DQ/H-matris + prioriteringskarta.
- **Fas 4a (KLAR — Gate 4A passerad):** `docs/research/datamodell-research/06a-airtable-redesign.md` — 12 A-track-åtgärder (A1–A12). Inter-fas-kontrakt till S-track tydligt.
...
8. `~/Repon/miranon-media-admin/docs/research/datamodell-research/05-gap-vs-worldclass.md` — gap-analysen
9. `~/Repon/miranon-media-admin/docs/research/datamodell-research/06a-airtable-redesign.md` — **A-track-leveransen, läs särskilt Del F (inter-fas-kontrakt)**
...
12. `~/Repon/miranon-media-admin/docs/research/datamodell-research/01-extraction.md`
13. `~/Repon/miranon-media-admin/docs/research/datamodell-research/02-live-state.md`
14. `~/Repon/miranon-media-admin/docs/research/datamodell-research/03-gap-analysis.md`
15. `~/Repon/miranon-media-admin/docs/conversion-plan.md`

**Föregående fas-prompter (för disciplin- och stilkonsistens):**

16. `~/Repon/miranon-media-admin/tasks/sessions/archive/datamodell-research-2026-04-30/fas-4a-prompt.md`
...
`~/Repon/miranon-media-admin/docs/research/datamodell-research/06b-supabase-target.md` — **ny fil**.
...
4. Skapa `docs/research/datamodell-research/06b-supabase-target.md` med skelett enligt §3.2.
