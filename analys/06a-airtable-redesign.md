...
| Spårbarhet | DS1; `docs/data-model.md:1170`; `analys/02-live-state.md:166`; `analys/05-gap-vs-worldclass.md:38` |
...
| Spårbarhet | DQ8; `docs/data-model.md:940`; `docs/data-model.md:1186`; `analys/01-extraction.md:497`; `analys/05-gap-vs-worldclass.md:173` |
...
| Spårbarhet | DQ9; `docs/data-model.md:651`; `docs/data-model.md:1192`; `analys/01-extraction.md:505`; `analys/05-gap-vs-worldclass.md:188` |
...
| Spårbarhet | DS2; `docs/data-model.md:574`; `analys/05-gap-vs-worldclass.md:53`; `analys/04-research.md:68` |
...
| Spårbarhet | DQ1; `docs/data-model.md:1142`; `analys/02-live-state.md:140`; `analys/05-gap-vs-worldclass.md:68` |
...
| Spårbarhet | DS3, DS4, DS5, H8; `docs/data-model.md:1176`; `docs/data-model.md:1182`; `analys/02-live-state.md:247`; `analys/05-gap-vs-worldclass.md:113` |
...
| Spårbarhet | DQ2, DQ3, H10, H11; `docs/data-model.md:1154`; `analys/02-live-state.md:204`; `analys/02-live-state.md:370`; `analys/05-gap-vs-worldclass.md:143` |
...
| Spårbarhet | DQ4, H6; `tasks/sessions/2026-04-28-datamodell-research-projekt.md:111`; `docs/data-model.md:1160`; `analys/05-gap-vs-worldclass.md:158` |
...
| Spårbarhet | DQ6, H2; `docs/data-model.md:1110`; `docs/hur-systemet-funkar.md:177`; `analys/05-gap-vs-worldclass.md:8` |
...
| Rollback | Se A4. |
| Spårbarhet | DS2; `docs/data-model.md:574`; `analys/05-gap-vs-worldclass.md:53` |
...
| Spårbarhet | H9, DS4/DS5-kontext; `docs/data-model.md:337`; `analys/02-live-state.md:245`; `analys/05-gap-vs-worldclass.md:113` |
...
| Spårbarhet | H1, H5; `docs/data-model.md:557`; `docs/data-model.md:597`; `analys/05-gap-vs-worldclass.md:83` |
