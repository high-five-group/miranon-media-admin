 ...
 * prototyp-eran).
 *
 * [RIVET, TASK-435, 2026-09-08] BETALNINGARNAS SKRIVBLOCK SOM STOD HÄR
 * (`BetalningsSkrivYta` m.fl., `useSetPaymentStatus`/`useUpdatePaymentNote`)
 * ÄR RIVET. Betalningar hanteras numera uteslutande på betalningssidan
 * (inkorg + bekräftelsesteg, PRD `TASK-402`); noteringar skrivs i
 * registreringsformuläret (`RegistreraForm.tsx` § NOTERINGSFÄLTET). Se
 * `docs/decisions/ADR-128-*.md` § Updates 2026-09-08 och
 * `docs/specs/ATGARDSSIDAN-UNDERLAG.md` § 5 (SUPERSEDED) för hela
 * historien. Historiken finns kvar i versionshanteringen
 * (git log -p --
