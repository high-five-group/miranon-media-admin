...
/**
 * [PROTOTYPE] K7 — Marcus K6-feedback 2026-07-07 (S55 Del 8):
 * kortrubrikerna IN i korten igen, STORA som "Fjärrskådning"
 * (text-xl semibold — FK-tydligt) i färgen de faktiskt renderade före
 * ljusgrå-testet (mörka default via base.css-regeln; utflytts-testet
 * förkastat); anmälningsradernas typsnittstorlekar tillbaka till
 * K5-formen (namn bas semibold / event text-small) med tiden KVAR exakt
 * som K6 ("för 10 min sedan", caption muted); exempeldata-noterna
 * BORTTAGNA ur båda rutorna; innehållsbredden till K1:s 600 px och
 * verkliga botten-tabbaren kvar (box-assertad IDENTISK med K1:s).
 * Zebra + koppar-kontur + loggens fyllton kvar från K6 (obedömda/
 * godkända). Kastas med prototypen.
 */
...
// ── K7 — komposition: K1-menyn tillbaka (botten-tabbaren, alla breakpoints) ──
export function K7() {
  return (
