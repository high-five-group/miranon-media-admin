            ...
            <MessageBox intent="info" title="Inget att skicka just nu">
              {svepTyp === 'bekraftelse'
                ...
                : svepTyp === 'paminnelse'
                  ...
                  : 'Alla bekräftade deltagare har redan fått deltagarinformation.'}
            </MessageBox>
          </div>
        )}
      </div>
