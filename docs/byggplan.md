...
> **Rad W tillagd 2026-09-19 ([ADR-134](decisions/ADR-134-publik-webbplats-fore-fas-e-delad-at-max.md), UTKAST — väntar Marcus granskning).** En ny fas läggs in FÖRE Fas E: FÖRESLAGET namn "Fas W — Publik webbplats (nya miranon.se)", namnet är INTE Marcus-kvitterat (se ADR-134 § Öppna frågor). Körs PARALLELLT med pågående Fas 6-arbete och CI-/grindarkitekturen, inte i sekvens efter dem. Samtidigt amenderas raden AT‑Max (delning + riven premiss) och raden E (nya förkrav) — se noterna vid respektive rad nedan.
...
**DELAD SEDAN 2026-09-19 (ADR-134, UTKAST):** (a)+(b) — migrationsdelen — är ett Fas E-förkrav, körd EFTER Fas W. (c) — mall-maxningsdelen, slutgenomlysningen — löper EFTER Fas E, oförändrat.
...
>
> **AMENDERAT 2026-09-19 (öppen ändring, ej tyst — [ADR-134](decisions/ADR-134-publik-webbplats-fore-fas-e-delad-at-max.md), UTKAST, väntar Marcus granskning):** Fas E förblir "sist av alla byggplans-delar" i §2-tabellens ordning — en ny fas W (Publik webbplats, FÖRSLAG) läggs in FÖRE denna rad, inte efter, och Fas E:s roll som Övning 2:s enda namngivna slutfas är oförändrad. Vad ADR-134 ändrar är TIMINGEN för när fasen kan aktualiseras (nya förkrav i § Beroenden nedan), inte dess plats som slutfas. Se [ADR-068](decisions/ADR-068-ovnings-ramverket.md) § Updates 2026-09-19 för den fulla tolkningsfrågan.
...
- **Fas W lanserad** (ny rad, **tillagd 2026-09-19 per [ADR-134](decisions/ADR-134-publik-webbplats-fore-fas-e-delad-at-max.md), UTKAST**) — sajten byggs och lanseras genom Väg A (EF-protokollet) innan Fas E aktualiseras, det är hela skälet ordningen vändes (ADR-134 § Kontext).
- **AT‑Max:s migrationsdel — (a)+(b) — avslutad** (ny rad, **tillagd 2026-09-19 per ADR-134, UTKAST**) — interaktions-registret måste vara komplett, inklusive Fas W:s tillskott, innan migrationsordningen inom Fas E kan planeras. Se § Milstolpe — Airtable-bas-maximering ovan.
...
| **1.18** | **2026-09-19** | **UTKAST — Ny fas W (Publik webbplats) infogad FÖRE Fas E; AT‑Max delas — väntar Marcus granskning av [ADR-134](decisions/ADR-134-publik-webbplats-fore-fas-e-delad-at-max.md).** Session 128 grillad samsyn (arton beslut, Marcus kvittens *"Låter bra. Jag kvitterar."*) beslutade att en publik webbplats (nya miranon.se) byggs FÖRE Fas E, inte efter — Väg A (sajten talar enbart med Edge Function-lagret) löser upp `T79`:s tidigare slutsats att pull-modellen band sajten till Fas E-tajmingen. **§2 fas-tabell:** ny rad **W** infogad mellan raderna B och E (16 → 17 rader), FÖRESLAGET namn "Fas W — Publik webbplats (nya miranon.se)" ej Marcus-kvitterat; raden **AT‑Max** amenderad öppet (premissen "hela ytan byggd av Fas 6:s EF ensamt" håller inte längre — milstolpen delas i en migrationsdel, Fas E-förkrav, och en mall-maxningsdel efter Fas E); raden **E** amenderad med två nya förkrav (Fas W lanserad, AT‑Max:s migrationsdel avslutad) och två kända arv (`psionautics.se`-Zappen, Soundwise-bryggan). **§4:** Milstolpe-blocket (blockquote + Mål + Beroenden) och Fas E-blocket (inledande blockquote + Beroenden + kända arv) amenderade i samma öppna form som tidigare landningar i denna tabell. **[ADR-068](decisions/ADR-068-ovnings-ramverket.md) § Updates** och **[ADR-063](decisions/ADR-063-airtable-bas-som-forstklassig-leverabel.md) § Updates** bär motsvarande noter. **Status: UTKAST** — denna landning är en DRAFT-PR för Marcus granskning (ADR-134 är `Proposed`, inte `Accepted`); fasens namn, DoD och estimat är öppna frågor tills granskningen är klar. |
