...
17 rader. Sekvens följer §5 i direktivet efter P1-applicering 2026-05-04. Estimat anges per fas; sub-fas-allokering under Fas 6 listas i Fas 6-prompten. Rad 16 (AT‑Max) är en MILSTOLPE, inte en fas — se ADR-063 + §4-milstolpe-blocket.

> **Rad W tillagd 2026-09-19 ([ADR-134](decisions/ADR-134-publik-webbplats-fore-fas-e-delad-at-max.md), Accepted).** En ny fas läggs in FÖRE Fas E: namnet "Fas W — Publik webbplats (nya miranon.se)" är fastställt (ADR-134, delegerat Marcus-mandat — se den ADR:ns Status-fält). Körs PARALLELLT med pågående Fas 6-arbete och CI-/grindarkitekturen, inte i sekvens efter dem. Samtidigt amenderas raden AT‑Max (delning + riven premiss) och raden E (nya förkrav) — se noterna vid respektive rad nedan.
...
| **W** | NY scope | **Publik webbplats (nya miranon.se)** — namn fastställt ([ADR-134](decisions/ADR-134-publik-webbplats-fore-fas-e-delad-at-max.md), Accepted 2026-09-19, delegerat Marcus-mandat). Spec-arbetet (stack-/repo-formsbeslut, PRD-dekomponering) pågår i S128; fasens BYGGE är inte påbörjat. Ersätter Shopify-mallen + Elfsight-widgetarna (kalender + anmälningsformulär) med en custom-byggd sajt som talar enbart med Supabase Edge Function-lagret (Väg A) — aldrig direkt med datakällan, så Fas E:s datakälle-byte inte kräver att sajten byggs om. Körs PARALLELLT med Fas 6:s återstående ytor (S127) och CI-/grindarkitekturen (S126), placerad FÖRE Fas E eftersom den löser upp T79:s tidigare slutsats ("pull-modellen binds till efter Fas E"). Scope i korthet (fullständigt i ADR-134 + källorna den pekar på): publik anmälningsväg utan inloggning, publicerings-kontraktet (fyra axlar, additiva bas-fält), "Event nära dig" + karta, kontaktformulär med filuppladdning (loggas som lead, `T189`), ljudspelare med Soundwise-brygga. Källor: [ADR-134](decisions/ADR-134-publik-webbplats-fore-fas-e-delad-at-max.md), `tasks/sessions/2026-09-19-session-128.md` Del 1–6, `tasks/threads/T79-custom-miranon-se-webbplats-app-samverkan-marcus.md`. Stack/repo-form och fasens DoD är ÖPPNA — avgörs separat, PRD-kort kommande. | (sätts vid PRD-dekomponeringen — ingen provisorisk siffra) |
| **E** | DEFER | Supabase-migration enligt 07 §A2. **Övning 2:s namngivna SLUTFAS ([ADR-068](decisions/ADR-068-ovnings-ramverket.md)) — designas i egen ADR när fasen närmar sig.** **HORISONTEN OMANKRAD 2026-07-27 (S91 premiss 4):** aktualiseras när **appens sidor är klara**, inte post-Fas 7 — se §4 Fas E § Horisont. Inkluderar Realtime-omläggning per B1. **NYA FÖRKRAV TILLAGDA 2026-09-19 ([ADR-134](decisions/ADR-134-publik-webbplats-fore-fas-e-delad-at-max.md), Accepted):** AT‑Max:s migrationsdel ((a)+(b) ovan) avslutad, och Fas W lanserad — se §4 Fas E § Beroenden för fulltexten. Ärver `psionautics.se`-Zappen (A12) och Soundwise-bryggan som kända arv att dra om vid datakälle-bytet. | (defer, separat planering) |
...
Full trail: `tasks/sessions/archive/2026-08/2026-08-11-session-105.md` + PRD-kortets DoD.
...
>
> **AMENDERAT 2026-09-19 (öppen ändring, ej tyst — [ADR-134](decisions/ADR-134-publik-webbplats-fore-fas-e-delad-at-max.md), Accepted):** blockquotens FÖRSTA rad ovan — "placerad EFTER Fas 6.5 — då hela app↔Airtable-interaktions-ytan är byggd av Fas 6:s EF ensamt" — HÅLLER INTE LÄNGRE. Fas W (ny rad i §2, "Publik webbplats") lägger NYA app↔Airtable-interaktioner via sitt Edge Function-lager (Väg A) efter Fas 6.5, vilket gör interaktions-registret ofullständigt vid den gamla slotten. Milstolpen DELAS: **migrationsdelen — (a)+(b) nedan** — blir ett Fas E-förkrav och väntar in att Fas W:s Airtable-berörande skrivvägar är byggda (se § Beroenden nedan, ny rad); **mall-maxningsdelen — (c) nedan** — löper OFÖRÄNDRAT efter Fas E, som redan beslutat 2026-08-14. Se ADR-134 § Beslut 2 för hela motiveringen och exempel på vad Fas W tillför interaktions-ytan.
...
**DELAD SEDAN 2026-09-19 (ADR-134, Accepted):** (a)+(b) — migrationsdelen — är ett Fas E-förkrav, körd EFTER Fas W. (c) — mall-maxningsdelen, slutgenomlysningen — löper EFTER Fas E, oförändrat.
...
- **Fas W — migrationsdelen (a)+(b) ENBART** (ny rad, **tillagd 2026-09-19 per [ADR-134](decisions/ADR-134-publik-webbplats-fore-fas-e-delad-at-max.md), Accepted**): Fas W:s Airtable-berörande Edge Function-skrivvägar måste vara byggda innan interaktions-registret kan auditeras som KOMPLETT — se blockquoten ovan. Mall-maxningsdelen (c) har INGET beroende av Fas W; den löper efter Fas E oavsett.
...
>
> **AMENDERAT 2026-09-19 (öppen ändring, ej tyst — [ADR-134](decisions/ADR-134-publik-webbplats-fore-fas-e-delad-at-max.md), Accepted):** Fas E förblir "sist av alla byggplans-delar" i §2-tabellens ordning — en ny fas W (Publik webbplats) läggs in FÖRE denna rad, inte efter, och Fas E:s roll som Övning 2:s enda namngivna slutfas är oförändrad. Vad ADR-134 ändrar är TIMINGEN för när fasen kan aktualiseras (nya förkrav i § Beroenden nedan), inte dess plats som slutfas. Se [ADR-068](decisions/ADR-068-ovnings-ramverket.md) § Updates 2026-09-19 för den fulla tolkningsfrågan.
...
- **Fas W lanserad** (ny rad, **tillagd 2026-09-19 per [ADR-134](decisions/ADR-134-publik-webbplats-fore-fas-e-delad-at-max.md), Accepted**) — sajten byggs och lanseras genom Väg A (EF-protokollet) innan Fas E aktualiseras, det är hela skälet ordningen vändes (ADR-134 § Kontext).
- **AT‑Max:s migrationsdel — (a)+(b) — avslutad** (ny rad, **tillagd 2026-09-19 per ADR-134, Accepted**) — interaktions-registret måste vara komplett, inklusive Fas W:s tillskott, innan migrationsordningen inom Fas E kan planeras. Se § Milstolpe — Airtable-bas-maximering ovan.

> **ÖPPEN, MEDVETET EJ AVGJORD:** premiss 4 flyttade HORISONTEN — den sa ingenting om Fas 7:s roll. Fas 7-beroendet står därför kvar oförändrat, och förhållandet mellan det nya ankaret ("sidorna klara") och Fas 7:s deploy är **inte** löst av denna uppdatering. Frågan hör till Marcus när fasen aktualiseras; att tyst härleda ett svar ur premissen vore att besluta mer än premissen bär. **ADR-134 tillför två YTTERLIGARE förkrav (ovan) men löser inte heller Fas 7-frågan** — den förblir öppen, oförändrad.
>
> **KÄNDA ARV, tillagda 2026-09-19 (ADR-134, Accepted, källa: `tasks/sessions/2026-09-19-session-128.md` Del 6 — ej landad på `origin/main` vid denna landnings författning, citerad som filsökväg):** två Zapier-kopplingar hålls medvetet UTANFÖR Fas W:s lanseringsgrind och lever kvar vid sajtbytet, men måste dras om eller ersättas när Fas E byter lagringen bakom EF-lagret: **(1)** `psionautics.se`s Zap mot samma Airtable-bas (automation A12, "Zap 1 Anmälan-Psionautics.se") — Marcus: *"psionautics kan vi hålla utanför detta tillsvidare."* **(2)** Soundwise-bryggan (vår EF → Zapier → Soundwise; Soundwise → Zapier → vår EF), som lever kvar eftersom Soundwise dokumenterat bara nås via Zapier i dag (invite only) — ersätts direkt om Soundwise öppnar ett API innan dess.
...
| **1.18** | **2026-09-19** | **Ny fas W (Publik webbplats) infogad FÖRE Fas E; AT‑Max delas — [ADR-134](decisions/ADR-134-publik-webbplats-fore-fas-e-delad-at-max.md) Accepted.** Session 128 grillad samsyn (arton beslut, Marcus kvittens *"Låter bra. Jag kvitterar."*, beslut 8 och 13 i Del 3–4) beslutade att en publik webbplats (nya miranon.se) byggs FÖRE Fas E, inte efter — Väg A (sajten talar enbart med Edge Function-lagret) löser upp `T79`:s tidigare slutsats att pull-modellen band sajten till Fas E-tajmingen. ADR-134:s TEXT (kontext, beslut, alternativ, konsekvenser) granskades och godkändes av orkestreraren på Marcus delegerade mandat, 2026-09-19 — se ADR-134:s Status-fält för mandatets ordagranna citat; ett DELEGERAT GO, inte Marcus egen radgranskning av dokumentet. **§2 fas-tabell:** ny rad **W** infogad mellan raderna B och E (16 → 17 rader), namnet "Fas W — Publik webbplats (nya miranon.se)" fastställt under samma delegerade mandat; raden **AT‑Max** amenderad öppet (premissen "hela ytan byggd av Fas 6:s EF ensamt" håller inte längre — milstolpen delas i en migrationsdel, Fas E-förkrav, och en mall-maxningsdel efter Fas E); raden **E** amenderad med två nya förkrav (Fas W lanserad, AT‑Max:s migrationsdel avslutad) och två kända arv (`psionautics.se`-Zappen, Soundwise-bryggan). **§4:** Milstolpe-blocket (blockquote + Mål + Beroenden) och Fas E-blocket (inledande blockquote + Beroenden + kända arv) amenderade i samma öppna form som tidigare landningar i denna tabell. **[ADR-068](decisions/ADR-068-ovnings-ramverket.md) § Updates** och **[ADR-063](decisions/ADR-063-airtable-bas-som-forstklassig-leverabel.md) § Updates** bär motsvarande noter. Kvar öppet, oförändrat av flippen till Accepted: när AT‑Max:s migrationsdel får starta (byggd kontra lanserad Fas W), stack-/repo-formsbeslutet, fasens DoD/estimat, förhållandet till Fas 7, och den overifierade Zap-listan (inkl. sidofyndet Zap 2) — se ADR-134 § Öppna frågor. |
