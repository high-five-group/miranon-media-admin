...
- **Skörd:** **task-39–48** (10 kort) · **T91** · **L339–L342** [UNIVERSAL ×4] · pilot-loggrader ×6 i T86 · ny EF `get-registration` (staging; prod-allowlisten orörd). T86:s escapes-kolumn **omtriagerad neutralt i två dimensioner** (diff-synliga vs browser-only) — räkne-regeln avgörs i T85-sessionen per sekvenslåsningen.
