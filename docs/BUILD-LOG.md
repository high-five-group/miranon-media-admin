...
**Sessionsdok-trail:** [`tasks/sessions/2026-06-27-session-38.md`](../tasks/sessions/2026-06-27-session-38.md) (Del 1 scope + Del 2 L0/L1/L2 + 6f arch-audit). Nästa (Chat dirigerar): 6e-retro-audit (T38) + 6h Mail + bundlad prod-deploy (fält + EF) före FULLT Fas 6-avslut.
