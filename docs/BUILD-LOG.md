...
- **Commit-range:** `10c0cedf` (bas vid start, 2026-08-29) → `[FYLL I sista landning]`. Nio pauser och nio resumes över fem kalenderdagar, i huvudkatalogen genom de flesta faserna (oisolerat för snabb HMR-loop under designpassen) med dokarbete i egna worktrees under senare resumes.
