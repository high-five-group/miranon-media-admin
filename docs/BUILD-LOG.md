...
**Sessionsdok-trail:** [`tasks/sessions/2026-06-27-session-38.md`](../tasks/sessions/2026-06-27-session-38.md) (Del 1 scope + Del 2 L0/L1/L2-landningar). Nästa: 6f arch-audit (ADR-058, Chat dirigerar) + bundlad prod-deploy (fält + EF) före FULLT Fas 6-avslut.
