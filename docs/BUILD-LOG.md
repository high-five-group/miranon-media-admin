...
- **FJS (Event-18) + RIM1 (Event-19)** (pre-paus): 20 walk-in-anmälningar (Marcus, Scripting), 2 kantfall fixade via MCP (Deltagare 42 reverse-flow; Deltagare 49 case-e-post-dubblett), **80 Deltaganden → Närvarande**, verifierat cross-event (Andreas 4/4).
