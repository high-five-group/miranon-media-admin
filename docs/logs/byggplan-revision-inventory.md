...
4. `docs/research/datamodell-research/04-research.md` → `docs/research/datamodell-research/08-odoo-validation.md` — datamodell-research (frusen efter Gate 6 + Odoo)
5. `marcus-system/tasks/lessons.md` (sektioner 2026-04-28 → 2026-05-04) — universella lärdomar
6. `tasks/sessions/archive/2026-05/2026-05-04-security-hardening.md` — Fas A-arbetsdokument (frusen efter slutsummering)
