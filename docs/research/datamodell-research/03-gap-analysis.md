...
| LÄGG TILL | Fälla 27: **`Är aktiv (1/0)` exkluderar inte "Inställt"** (DS1). Deltagare 64 #2 + Deltagare 21 #28 räknas som aktiva trots Inställt-Status. Åtgärd: uppdatera formeln till `IF(OR(Status="Avbokad/Ombokad", Status="Inställt"), 0, 1)`. Källa: 01-extraction §D.6. |
